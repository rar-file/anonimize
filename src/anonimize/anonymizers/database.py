...
class DatabaseAnonymizer(BaseAnonymizer):
    ...
    def __init__(
        ...
        **engine_kwargs
        ...
        try:
            ...
            logger.info(f"DatabaseAnonymizer initialized with: {self._safe_connection_string()}")
    ...
    def _anonymize_table(
        ...
        with self._get_connection() as conn:
            ...
            if not primary_key:
                ...
                return self._anonymize_table_without_pk(conn, table, config, columns_to_anonymize)
    ...
    def _anonymize_table_without_pk(
        ...
        """
        logger.warning(
            f"Processing table without primary key. "

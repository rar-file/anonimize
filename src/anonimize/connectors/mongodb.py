...
class MongoDBConnector(BaseConnector):
    ...
    def _get_database(self, client: MongoClient, database_name: Optional[str] = None) -> Database:
    ...
    def execute(
        ...
        try:
            ...
            collection = self._get_collection(connection, collection_name, database_name)
    ...
    def executemany(
        ...
        try:
            collection_name = query
            database_name = parameters_list[0].get("database") if parameters_list else None
            ...
            for params in parameters_list:
                ...
                if op == "insert":
                    ...
                    collection.update_one(filter_doc, {"$set": doc}, upsert=params.get("upsert", False))
                elif op == "delete":
    ...
    def get_columns(self, collection_name: str, schema: Optional[str] = None) -> List[ColumnInfo]:
    ...
    def get_primary_key(self, collection_name: str, schema: Optional[str] = None) -> List[str]:

...
class JSONAnonymizer(BaseAnonymizer):
    ...
    def anonymize(
        ...
        **kwargs,
        ...
        if is_jsonlines:
            return self._anonymize_jsonlines(input_path, output_path, config, **kwargs)
    ...
    def _anonymize_data(
        ...
        if isinstance(data, dict):
            ...
            return [
                self._anonymize_data(item, config, f"{current_path}[]") for item in data
            ]
    ...
    def _get_wildcard_config(
        self, path: str, config: Dict[str, Dict[str, Any]]
    ) -> Dict[str, Any]:
    ...
    def _apply_strategy(self, value: Any, settings: Dict[str, Any]) -> Any:
    ...
    def _anonymize_jsonlines(
        ...
        **kwargs,
        ...
        with open(input_path, encoding=self.encoding) as infile, open(

...
class TestEmailAnonymizer:
    ...
    def test_replace_strategy(self):
        ...
        result = anon.anonymize("john@example.com", strategy=AnonymizationStrategy.REPLACE)
    ...
    def test_remove_strategy(self):
        ...
        result = anon.anonymize("test@example.com", strategy=AnonymizationStrategy.REMOVE)
    ...
    def test_deterministic_strategy(self):
        ...
        result1 = anon.anonymize(
            "test@example.com",
            strategy=AnonymizationStrategy.DETERMINISTIC
        )
        result2 = anon.anonymize(
            "test@example.com",
            strategy=AnonymizationStrategy.DETERMINISTIC
...
class TestAnonymizerFactory:
    ...
    def test_register_invalid_anonymizer(self):
        ...
        with pytest.raises(TypeError, match="must inherit from BaseSpecializedAnonymizer"):
